...
# coding=utf-8
"""
Complete Table 2: Calibration Performance — ALL methods.
...
# ============================================================
# Calibration metrics (EXACT same as compute_table2.py)
# ============================================================
...
def main():
    ...
    detail_csv = os.path.join(BASE, 'results/table2_complete_detail.csv')
    ...
    lines = []
    lines.append('=' * 120)
    lines.append('Table 2: Calibration Performance of the Predictive Module (COMPLETE)')
    lines.append('=' * 120)
    ...
    # Save
    txt_path = os.path.join(BASE, 'results/table2_complete.txt')
    csv_path = os.path.join(BASE, 'results/table2_complete.csv')
