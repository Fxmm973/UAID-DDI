...
class MVN_DDI(nn.Module):
    def __init__(self, in_node_features, in_edge_features, hidd_dim, kge_dim, rel_total, heads_out_feat_params,
    ...
    def forward(self, triples):
        ...
        _, _, h_data_fin, h_data_desc, t_data_fin, t_data_desc = self.fdmer(h_data_fin, h_data_desc, t_data_fin,
                                                                            t_data_desc)
